...
class multiparameter_landscape(object):
    ...
    def grid_yvalues(self):
        ...
        # Find the slope offset parametrisations of the 1 dimensional landscapes to be computed
    ...
    # Produce function which computes appropriate single parameter landscape for each diagonal slices
    ...
    # Antidiagonals of each matrix are labelled 0 to x_steps+y_steps-1 from top left to bottom right -
    # same indexing as corresponding barcodes
