...
def Rips_Codensity_Bifiltration(points, radius_range, kNN: int = None, maxind: int = None, dim: int = None, resolution: int = None):
    ...
    computed_data = Compute_Rivet(filtered_points, resolution=resolution, dim=dim, RipsMax=radius_range[1])
